...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", default="diffusion_pos_ood_compensation")
    ...
    sd_model_path = f'../Diffusion_models/sd_models/{args.env}.pth'
    ...
    args.state_threshold = round(get_state_threshold(state_distribution, diffusion_model, args.env, args.no_normalize, args.state_n_levels, args.batch_size), 6)
    args.action_threshold = round(get_action_threshold(behavior_model, diffusion_model, args.env, args.no_normalize, args.action_n_levels, args.batch_size), 6)
    print(f"State threshold for env '{args.env}' with state_n_levels {args.state_n_levels}: {args.state_threshold}")
    print(f"Action threshold for env '{args.env}' with action_n_levels {args.action_n_levels}: {args.action_threshold}")
    ...
    kwargs = {
        ...
        "Q_min": Q_min,
        "state_n_levels": args.state_n_levels,
